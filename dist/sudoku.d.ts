...
export declare class Sudoku<T extends ITile, N extends INote, G extends IGroup> {
    ...
    constructor(TILE_TYPE: {
        new (type: new (num: number, value: boolean, isInvalid: boolean) => N, id: number, value: number, blocked?: boolean, group?: G): T;
    }, NOTE_TYPE: {
 ...
 */
export declare class DefaultSudoku extends Sudoku<Tile<INote, IGroup>, Note, Group<ITile>> {
    constructor();
}
